...
const Usage = `Usage:
  ...
  broadcast-tester mclient ADDRESS PORT MESSAGE - send packet to multicast server at ADDRESS:PORT with MESSAGE
  broadcast-tester userver ADDRESS PORT MESSAGE - start UDP server at ADDRESS:PORT and respond to all packets with MESSAGE
  broadcast-tester uclient ADDRESS PORT MESSAGE - send packet to UDP server at ADDRESS:PORT with MESSAGE`
